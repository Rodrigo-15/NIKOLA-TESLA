...
class UserController:
    def create_users(type=None):
        ...
        for persona in personas:
            ...
            correo = (
                persona.nombres[0].lower()
                + apellido_paterno_sp.lower()
                + persona.apellido_materno[0].lower()
                + persona.numero_documento[5]
                + persona.numero_documento[6]
                + persona.numero_documento[7]
                + "@postgradounap.edu.pe"
            )
