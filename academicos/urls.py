...
urlpatterns = [
    ...
    path("get_cursos_by_programa_id", get_cursos_by_programa_id,
         name="get_cursos_by_programa_id"),
    path("get_cursos_grupos_by_cursos", get_cursos_grupos_by_cursos,
         name="get_cursos_grupos_by_cursos"),
    path("", include(router.urls)),
    path("bulks/", include(router_bulk.urls)),
    path("get_matricula_by_expediente_active", get_matricula_by_expediente_active,
         name="get_matricula_by_expediente_active"),
    path("get_horarios_matriculados_by_expediente", get_horarios_matriculados_by_expediente,
         name="get_horarios_matriculados_by_expediente"),
    path("get_cursos_by_docente", get_cursos_by_docente,
         name="get_cursos_by_docente"),
    path("get_docente", get_docente, name="get_docente"),
    path("get_alumnos_curso_grupo_by_id", get_alumnos_curso_grupo_by_id,
    ...
    path("get_estado_notas_curso_by_id", get_estado_notas_curso_by_id,
         name="get_estado_notas_curso_by_id"),
    path("get_cursos_matriculados_by_expediente", get_cursos_matriculados_by_expediente,
    ...
    path("get_programas_by_periodo", get_programas_by_periodo,
         name="get_programas_by_periodo"),
    path("get_alumno_by_expediente", get_alumno_by_expediente,
         name="get_alumno_by_expediente"),
    path("get_alumno_by_dni", get_alumno_by_dni, name="get_alumno_by_dni"),
    path("get_progreso_academico_by_expediente_id", get_progreso_academico_by_expediente_id,
