    ...
    def notification_email(self):
        ...
        html_content = f"""
            <html>
                ...
                <div class="bg-white">
                <p>
                <span class="font-bold">Remitente: </span> {self.file.person.nombres} {self.file.person.apellido_paterno} {self.file.person.apellido_materno}
                </p>
                <p>
